        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-11">
                        <input type="text" class="form-control tanggal_proses" name="tanggal_proses"
                            ...
                            value="{{ date_format(date_create($keluar->tanggal_proses), 'm/d/Y') }}" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-11">
                        <input type="text" class="form-control nama_customer" name="nama_customer" id="nama_customer"
                            placeholder="masukkan nama customer" value="{{ $keluar->nama_customer }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-11">
                        <input type="text" class="form-control no_telp" name="no_telp" id="no_telp"
                            placeholder="masukkan nomor telp" value="{{ $keluar->no_telp }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-11">
                        <textarea class="form-control alamat" name="alamat" id="alamat" placeholder="masukkan alamat">{{ $keluar->alamat }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-11">
                        <select name="jenis_pembayaran" id="jenis_pembayaran" class="form-control jenis_pembayaran">
                            ...
                            <option value="cash" {{ $keluar->jenis_pembayaran == 'cash' ? 'selected' : '' }}>Cash
                            </option>
                            <option value="transfer" {{ $keluar->jenis_pembayaran == 'transfer' ? 'selected' : '' }}>
                                Transfer</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-11">
                        <textarea name="kondisi_pasien" id="kondisi_pasien" class="form-control" rows="6" placeholder="keterangan">{{ $keluar->kondisi_pasien }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <input type="checkbox" class="checkbox-produk"
                                                ...
                                                {{ checkedData($keluar->data, $produk->id)['checked'] }}>
                                        </td>
                                        <td>{{ $produk->nama }}</td>
                                        ...
                                        <td>
                                            <input class="form-control jumlah-produk"
                                                {{ checkedData($keluar->data, $produk->id)['checked'] == 'checked' ? '' : 'disabled' }}
                                                id="jumlah-produk{{ $produk->id }}" data-id="{{ $produk->id }}"
                                                data-stok="{{ $produk->stok }}" name="jumlah-produk[]"
                                                data-beli="{{ $produk->harga_beli }}"
                                                data-jual="{{ $produk->harga_jual }}"
                                                value="{{ checkedData($keluar->data, $produk->id, 'jumlah')['data'] }}">
                                            <div class="invalid-feedback error-jumlah-{{ $produk->id }}"></div>
                                        </td>
                                        <td>
                                            <span
                                                id="total-harga{{ $produk->id }}">{{ checkedData($keluar->data, $produk->id)['checked'] == 'checked' ? checkedData($keluar->data, $produk->id, 'jumlah')['data'] * $produk->harga_jual : 0 }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
